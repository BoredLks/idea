...
% ===== 第13步: 缓存决策 (位置感知 + IU协作) =====
% ★ 新增参数: user_file_req_prob, now_user_positions, iu_coverage
% cache_decision = cal_cache_decision_MOIS(h, total_users, F, iu_count_per_community, ...
%     nf, v_chi_star, D_eg, D_iu, iu_indices, fused_preference, ...
%     user_file_req_prob, per_user_positions, iu_coverage);
...
fprintf('  命中率: 总=%.1f%%, IU=%.1f%%, SBS=%.1f%%\n', cache_hit_rate*100, iu_hit_rate*100, sbs_hit_rate*100);
